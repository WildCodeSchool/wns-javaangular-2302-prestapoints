...
public class UserControllerTests {
    ...
    public void testCreateUser_ShouldReturnStatusOk() throws Exception {
        ...
        userDto.setEmail("charly@test.com");
    ...
    // @Test
    // public void testCreateUser_ShouldReturnStatusBadRequest() throws Exception {
    //     // Arrange
    //     UserDto userDto = new UserDto();
    ...
    //             .content(bodyUser))
    //             .andExpect(status().isOk())
    //             .andExpect(jsonPath("$.message").value("L'email n'est pas conforme.")); // ajustez le message selon votre implémentation
    // }
