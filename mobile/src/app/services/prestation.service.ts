...
export class PrestationService {
  ...
  addRegistration(id: number | undefined): Observable<ResponseApi> {
    this.apiUrl =
      'http://192.168.1.182:8080/prestations/prestation/registration';
  ...
  undoRegistration(id: number | undefined): Observable<ResponseApi> {
    this.apiUrl =
      'http://192.168.1.182:8080/prestations/prestation/registration/suppression/' +
      id;
